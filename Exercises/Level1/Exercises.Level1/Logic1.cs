...
public class Logic1
{
    ...
    public bool SquirrelPlay(int temp, bool isSummer)
    {
        ...
        // 1. Ja tempereatūra ir virs 60 un zem 90 (nav vasara) tad atgriežam vērtību true
        if (temp < 60)
        {
            return false;
        }
        ...
        // 2. Ja tempereatūra ir virs 60 un zem 100 un ir vasara tad atgriežam vērtību true
        if (temp <= maxTemp)
        {
            return true;
        }
